...
const rows = [
  createData("Antonio Silva", "Mestrado", "2022.2"),
  createData("Rodrigo Meliande", "Doutorado", "2020.2"),
  createData("Wanderley Antunes", "Doutorado", "2022.1"),
  createData("Kleiton Costa", "Doutorado", "2020.2"),
  createData("Zé Carlos", "Mestrado", "2021.2"),
  createData("Rafael Magalhães", "Mestrado", "2021.2"),
  createData("Bernardo Magalhães", "Mestrado", "2021.2"),
];
