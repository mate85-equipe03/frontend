...
## Como contribuir
Todos os _commits_ devem ser feitos a partir de uma _branch_ não protegida, e submetidos via _Pull Request (PR)_ para o _merge_ para a `main`. Para serem mergeados, os PRs devem estar de acordo com os seguintes critérios:
* Passar pelos testes; 
